 ...
 */
export class BremenAdapter {
    state = 'Bremen';
    stateCode = 'HB';
    isFallback = false;
    baseUrl = 'https://www.geobasisdaten.niedersachsen.de/doorman/noauth';
    endpoints = [
        'WFS_borisHB',
        'WFS_borisHB_2024',
        'WFS_borisHB_2022',
    ...
    discoveredTypeNames = {};
    relevantTypePatterns = ['BodenrichtwertZonal', 'BodenrichtwertLagetypisch'];
...
//# sourceMappingURL=bremen.js.map