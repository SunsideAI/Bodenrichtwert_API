 ...
 */
export class SchleswigHolsteinAdapter {
                ...
                try {
                    ...
                    if (layers.length > 0) {
                        ...
                        const sorted = brwLayers.sort((a, b) => {
                            ...
                            if (a.includes('Bodenrichtwert') && !b.includes('Bodenrichtwert'))
                                return -1;
                            if (b.includes('Bodenrichtwert') && !a.includes('Bodenrichtwert'))
                                return 1;
                            return 0;
                        });
    ...
    async queryWms(lat, lon, wmsUrl, layer) {
        const delta = 0.001;
    ...
    extractHtmlField(html, fieldNames) {
...
//# sourceMappingURL=schleswig-holstein.js.map